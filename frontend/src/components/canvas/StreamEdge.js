...
export default function StreamEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, style = {}, markerEnd, label, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(BaseEdge, { path: edgePath, markerEnd: markerEnd, style: {
                    ...
                    stroke: streamResult?.vapor_fraction != null
                        ...
                        : '#60a5fa',
                    strokeWidth: 2,
                }, id: id }), displayLabel && (_jsx(EdgeLabelRenderer, { children: _jsx("div", { style: {
                        position: 'absolute',
                        transform: `translate(-50%, -50%) translate(${labelX}px, ${labelY}px)`,
                        pointerEvents: 'all',
                    }, className: "rounded bg-gray-800/90 px-2 py-0.5 text-[10px] text-gray-300 border border-gray-600", children: displayLabel }) }))] }));
}
