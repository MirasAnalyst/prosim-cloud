...
export const equipmentLibrary: Record<EquipmentType, EquipmentDefinition> = {
  ...
  [EquipmentType.Mixer]: {
    ...
    ports: [
      ...
      { id: 'in-3', name: 'Feed 3', position: 'left', type: 'inlet', required: false },
      { id: 'in-4', name: 'Feed 4', position: 'left', type: 'inlet', required: false },
  ...
  [EquipmentType.DistillationColumn]: {
    ...
    parameters: {
      ...feedConditionParams,
      numberOfStages: { label: 'Number of Stages', unit: '', default: 10, min: 2, max: 200, type: 'number', group: 'Column' },
      feedStage: { label: 'Feed Stage', unit: '', default: 5, min: 1, max: 200, type: 'number', group: 'Column' },
      refluxRatio: { label: 'Reflux Ratio', unit: '', default: 1.5, min: 0.01, max: 100, type: 'number', group: 'Column' },
      distillateToFeedRatio: { label: 'D/F Ratio', unit: '', default: 0.5, min: 0.01, max: 0.99, type: 'number', group: 'Column' },
      method: { label: 'Method', unit: '', default: 'FUG', type: 'string', group: 'Column', options: ['FUG', 'Rigorous'] },
      lightKey: { label: 'Light Key', unit: '', default: '', type: 'string', group: 'Column' },
      heavyKey: { label: 'Heavy Key', unit: '', default: '', type: 'string', group: 'Column' },
      lkRecovery: { label: 'LK Recovery', unit: '%', default: 99, min: 50, max: 99.99, type: 'number', group: 'Column' },
      hkRecovery: { label: 'HK Recovery', unit: '%', default: 99, min: 50, max: 99.99, type: 'number', group: 'Column' },
      condenserType: { label: 'Condenser Type', unit: '', default: 'total', type: 'string', group: 'Condenser / Reflux Drum', options: ['total', 'partial'] },
      condenserPressure: { label: 'Condenser Pressure', unit: 'kPa', default: 101.325, min: 0, max: 50000, type: 'number', group: 'Condenser / Reflux Drum' },
      condenserSubcooling: { label: 'Subcooling', unit: '°C', default: 0, min: 0, max: 50, type: 'number', group: 'Condenser / Reflux Drum' },
      condenserDuty: { label: 'Condenser Duty (0=auto)', unit: 'kW', default: 0, min: 0, max: 1e8, type: 'number', group: 'Condenser / Reflux Drum' },
      reboilerType: { label: 'Reboiler Type', unit: '', default: 'kettle', type: 'string', group: 'Reboiler', options: ['kettle', 'thermosiphon'] },
      reboilerPressure: { label: 'Reboiler Pressure (0=auto)', unit: 'kPa', default: 0, min: 0, max: 50000, type: 'number', group: 'Reboiler' },
      reboilerDuty: { label: 'Reboiler Duty (0=auto)', unit: 'kW', default: 0, min: 0, max: 1e8, type: 'number', group: 'Reboiler' },
      feed2Stage: { label: 'Feed 2 Stage', unit: '', default: 0, min: 0, max: 200, type: 'number', group: 'Multi-Feed / Side Draw' },
      sideDrawStage: { label: 'Side Draw Stage', unit: '', default: 0, min: 0, max: 200, type: 'number', group: 'Multi-Feed / Side Draw' },
      sideDrawType: { label: 'Side Draw Type', unit: '', default: 'liquid', type: 'string', group: 'Multi-Feed / Side Draw', options: ['liquid', 'vapor'] },
      sideDrawFlowFraction: { label: 'Side Draw Flow Fraction', unit: '', default: 0.1, min: 0.01, max: 0.5, type: 'number', group: 'Multi-Feed / Side Draw' },
      sideDrawStage2: { label: 'Side Draw 2 Stage', unit: '', default: null, min: 1, max: 200, type: 'number', group: 'Multi-Feed / Side Draw' },
      sideDrawType2: { label: 'Side Draw 2 Type', unit: '', default: 'liquid', type: 'string', options: ['liquid', 'vapor'], group: 'Multi-Feed / Side Draw' },
      sideDrawFlowFraction2: { label: 'Side Draw 2 Flow Fraction', unit: '', default: 0.1, min: 0.01, max: 0.5, type: 'number', group: 'Multi-Feed / Side Draw' },
      sideDrawStage3: { label: 'Side Draw 3 Stage', unit: '', default: null, min: 1, max: 200, type: 'number', group: 'Multi-Feed / Side Draw' },
      sideDrawType3: { label: 'Side Draw 3 Type', unit: '', default: 'liquid', type: 'string', options: ['liquid', 'vapor'], group: 'Multi-Feed / Side Draw' },
      sideDrawFlowFraction3: { label: 'Side Draw 3 Flow Fraction', unit: '', default: 0.1, min: 0.01, max: 0.5, type: 'number', group: 'Multi-Feed / Side Draw' },
      pumpAround1DrawStage: { label: 'PA 1 Draw Stage', unit: '', default: null, min: 1, max: 200, type: 'number', group: 'Pump-Around' },
      pumpAround1ReturnStage: { label: 'PA 1 Return Stage', unit: '', default: null, min: 1, max: 200, type: 'number', group: 'Pump-Around' },
      pumpAround1Duty: { label: 'PA 1 Duty', unit: 'kW', default: 0, min: 0, max: 100000, type: 'number', group: 'Pump-Around' },
      pumpAround2DrawStage: { label: 'PA 2 Draw Stage', unit: '', default: null, min: 1, max: 200, type: 'number', group: 'Pump-Around' },
      pumpAround2ReturnStage: { label: 'PA 2 Return Stage', unit: '', default: null, min: 1, max: 200, type: 'number', group: 'Pump-Around' },
      pumpAround2Duty: { label: 'PA 2 Duty', unit: 'kW', default: 0, min: 0, max: 100000, type: 'number', group: 'Pump-Around' },
    },
    ports: [
      { id: 'in-1', name: 'Feed', position: 'left', type: 'inlet' },
      { id: 'in-2', name: 'Feed 2', position: 'left', type: 'inlet', required: false },
      { id: 'out-1', name: 'Distillate', position: 'top', type: 'outlet' },
      { id: 'out-2', name: 'Bottoms', position: 'bottom', type: 'outlet' },
      { id: 'out-3', name: 'Side Draw', position: 'right', type: 'outlet', required: false },
      { id: 'out-4', name: 'Side Draw 2', position: 'right', type: 'outlet', required: false },
      { id: 'out-5', name: 'Side Draw 3', position: 'right', type: 'outlet', required: false },
  ...
  [EquipmentType.Stripper]: {
    ...
    parameters: {
      ...
      numberOfStages: { label: 'Number of Stages', unit: '', default: 10, min: 2, max: 200, type: 'number' },
      pressure: { label: 'Pressure', unit: 'kPa', default: 101.325, min: 0, max: 50000, type: 'number' },
      reboilerDuty: { label: 'Reboiler Duty', unit: 'kW', default: 1000, min: 0, max: 1e8, type: 'number', group: 'Reboiler' },
      reboilRatio: { label: 'Reboil Ratio', unit: '', default: 0.3, min: 0.01, max: 2.0, type: 'number', group: 'Reboiler' },
      reboilerTemperature: { label: 'Reboiler Temperature', unit: '°C', default: null, min: 50, max: 400, type: 'number', group: 'Reboiler' },
    },
    ports: [
      { id: 'in-1', name: 'Rich Solvent', position: 'top', type: 'inlet' },
      { id: 'in-2', name: 'Stripping Gas', position: 'bottom', type: 'inlet', required: false },
  ...
  [EquipmentType.ThreePhaseSeparator]: {
    ...
    parameters: {
      ...feedConditionParams,
      lightLiquidFraction: { label: 'Light Liquid Fraction (override)', unit: '', default: null, min: 0, max: 1, type: 'number' },
